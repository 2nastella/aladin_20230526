...
$(function () {
  $.ajax({
    ...
    $(".bestseller")
      .eq(0)
      .append('<div class="book_img"><a href="#" target="_blank"><img src=' + data.documents[0].thumbnail + '/></a></div>')
      .append('<div class="book_num">1</div>')
      .append('<div class="book_info"><p class="booktitle"><a href="#" target="_blank">' 
      + data.documents[0].title + '</a></p><p class="author"><a href="#" target="_blank">' 
  ...
  $.ajax({
    ...
    $(".bestseller")
      ...
      .append('<div class="book_info"><p class="booktitle"><a href="#" target="_blank">' 
      + data.documents[4].title + '</a></p><p class="author"><a href="#" target="_blank">' 
